export const IconlyTickSquare = ({ size = 24, color = "#0aa2ee" }) => {
  return (
    <svg 
      width={size} 
      height={size} 
    ...
    >
      ...
      <g id="Iconly/Light/Tick-Square" stroke="none" strokeWidth="1.5" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
        <g id="Tick-Square" transform="translate(2.000000, 2.000000)" stroke={color} strokeWidth="1.5">
